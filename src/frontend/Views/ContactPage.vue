<template>
    <LayoutComp>
        ...
        <section class="bg-white md:h-5/6 py-10 md:py-28">
            <div class="py-8 md:py-16 px-4 mx-auto max-w-screen-md mb-3">
                <h2 class="mb-4 text-2xl md:text-3xl tracking-tight font-extrabold text-center text-gray-900">Me
                    contacter</h2>
                <p class="mb-8 lg:mb-16 pt-3 font-light md:text-center text-gray-700 md:text-lg">Vous avez des
                ...
                <form @submit.prevent="handleSubmit" class="space-y-8">
                    ...
                    <button type="submit"
                        class="py-3 px-5 text-sm font-medium text-center text-white rounded-lg bg-info sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300">Envoyer</button>
                </form>
            </div>
        </section>
    </LayoutComp>
