          ...
          <div class="md:p-6 bg-white md:py-24">
            ...
            <form @submit.prevent="handleSubmit" method="POST" enctype="multipart/form-data">
              ...
              <div class="mb-8">
                ...
                <textarea v-model="content" id="content" name="content" autocomplete="content" required="true"
                  type="text"
                  class="mt-5 shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full h-60 p-2.5">
                                </textarea>
              </div>

              <div class="flex text-gray-600">
                <button role="submit"
                  class="md:w-32 flex w-full justify-center rounded-md bg-success px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-info focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                  required>Poster</button>
              </div>
            </form>
          </div>
        </div>
